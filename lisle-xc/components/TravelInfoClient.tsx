...
import { Search, MapPin, Car, Coffee, Map, Navigation, Trophy, Clock, Activity } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {filteredLocations.map((info) => (
          ...
          >
            ...
            {/* Card Footer */}
            <div className="p-5 border-t border-border bg-background/50 flex flex-col sm:flex-row flex-wrap gap-3">
              {info.GmapsLink && (
                <Button 
                  as="a" 
                  href={info.GmapsLink} 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="flex-1 w-full gap-2 justify-center min-w-35"
                >
                  <Navigation size={16} />
                  Get Directions
                </Button>
