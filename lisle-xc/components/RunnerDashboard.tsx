...
export default function RunnerDashboard({ 
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8 mt-1.5 px-4 sm:px-6 lg:px-8 pb-12">
      ...
      {/* CONDITIONAL RENDER: Check if there are no results */}
      {results.length === 0 ? (
        
        <div className="bg-background rounded-3xl p-6 md:p-8 border border-border shadow-sm mt-8">
          <div className="prose max-w-none text-foreground">
            ...
            <p className="leading-relaxed mb-4 text-base">
              <strong className="text-foreground">{runner.Name}</strong> is a former cross country runner for Lisle High School. 
              While specific meet times and race results for this athlete are not currently available 
              in our digital archives, {runner.Name} is recognized as an official member of the Lisle cross country team roster.
            </p>
            <p className="leading-relaxed text-base text-light-gray italic">
              If you have historical results, photos, or information regarding this athlete's time 
              on the Lisle Cross Country team, please contact <a className="text-foreground" href="mailto:dmiller@lisle202.org">Coach Miller</a> to help us update our records!
            </p>
          </div>
        </div>
